function form_validate_delete_file() {
    ...
    if($("#checkbox1").prop("checked") == false){
        ...
        form_generate_alert("alert-checkbox-1", "alert-danger bsclassic-alert-danger", "You cannot delete this file without indicating your sureness.");
    } else {
