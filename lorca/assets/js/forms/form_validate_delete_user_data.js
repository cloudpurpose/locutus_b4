function form_validate_delete_user_data() {
    ...
    if($("#checkbox1").prop("checked") == false){
        ...
        form_generate_alert("alert-checkbox-1", "alert-danger bsclassic-alert-danger", "You cannot delete this record without indicating your sureness.");
    } else {
